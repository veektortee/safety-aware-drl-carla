...
SENSOR_FPS              = 30
VERBOSE                 = False
VEHICLE_SENSORS_FILE    = 'CARLA-GymDrive/src/config/default_sensors.json'
VEHICLE_PHYSICS_FILE    = 'CARLA-GymDrive/src/config/default_vehicle_physics.json'
...
ENV_SCENARIOS_FILE      = 'CARLA-GymDrive/src/config/default_scenarios.json'
