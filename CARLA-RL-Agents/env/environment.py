...
class CarlaEnv(gym.Env):
    ...
    def step(self, action):
        ...
        reward = self.__reward_func.calculate_reward(self.__vehicle, self.__reward_current_pos, self.__reward_target_pos, self.__reward_next_waypoint_pos, self.__reward_speed, world=self.__world.get_world(), cbf_correction_magnitude=0.0)
